...
import sjtu.opennet.textilepb.Mobile.MobileWalletAccount;
import sjtu.opennet.textilepb.View.Summary;
...
public class Textile implements LifecycleObserver {
    ...
    /**
     * Provides access to Textile threads2 related APIs
     */
    public Threads2 threads2;
...
//            lifecycleService.stopNodeAfterDelay();
    ...
    public void connectShadow(String ip, int port, Handlers.ConnectShadowHandler connectShadowHandler){
        node.connectShadowTCP_Async(ip, port, new Callback() {
            @Override
            public void call(Exception e) {
                if(e==null){
                    connectShadowHandler.onSuccess();
                }
            }
        });
    }

    public void connectShadowRelay(String id){
        node.tryConnectShadowByRelay(id);
    }
//
//    public void thread2(){
//        node.createGroup("");
