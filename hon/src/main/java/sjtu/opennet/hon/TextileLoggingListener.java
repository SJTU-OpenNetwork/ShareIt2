...
public class TextileLoggingListener extends BaseTextileEventListener {
    ...
    @Override
    public void thread2UpdateReceived(final String threadId, final Thread2Data thread2Data) {
        super.thread2UpdateReceived(threadId, thread2Data);
        System.out.println("------------> thread2 update received: " + threadId);
    }
