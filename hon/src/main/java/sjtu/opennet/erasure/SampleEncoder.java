...
public class SampleEncoder {
    ...
    public static final int DATA_SHARDS = 4; //数据
    public static final int PARITY_SHARDS = 2; //允许丢失
    public static final int TOTAL_SHARDS = 6; //一共的数据
    ...
    public static void main(String [] arguments) throws IOException {
        ...
        for (int i = 0; i < DATA_SHARDS; i++) { //从allBytes中的i*shardSize处读shardSize数的数据到shard[i]中
